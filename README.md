...
🔮 Mon ambition est de développer mon expertise dans :  
- **Endpoint Security & EDR (Microsoft Defender, Intune)**  
- **Gestion des identités (IAM, MFA, Conditional Access)**  
- **GRC & conformité (NIST, ISO 27001, Zero Trust)**  
...
© 2025 Ali Choukatli – Tous droits réservés  
